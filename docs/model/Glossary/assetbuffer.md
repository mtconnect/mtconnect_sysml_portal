...
<span class="hoverterm">buffer<span class="definition" data-term="buffer">section of an *agent* that provides storage for information published from pieces of equipment.</span></span> for <span class="hoverterm">Assets<span class="definition" data-term="Asset">*asset* that is used by the manufacturing process to perform tasks.
