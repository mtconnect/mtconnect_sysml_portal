...
![CuttingTool]({% link figures/CuttingTool.png %} "CuttingTool"){: width="80.0%"}
...
![Cutting Tool Parts]({% link figures/Cutting Tool Parts.png %} "Cutting Tool Parts"){: width="80.0%"}
...
![Cutting Tool Composition]({% link figures/Cutting Tool Composition.png %} "Cutting Tool Composition"){: width="80.0%"}
...
![Cutting Tool, Tool Item, and Cutting Item]({% link figures/Cutting Tool, Tool Item, and Cutting Item.png %} "Cutting Tool, Tool Item, and Cutting Item"){: width="80.0%"}

![Cutting Tool, Tool Item, and Cutting Item 2]({% link figures/Cutting Tool, Tool Item, and Cutting Item 2.png %} "Cutting Tool, Tool Item, and Cutting Item 2"){: width="80.0%"}
