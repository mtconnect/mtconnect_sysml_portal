---
title: "Cutting Tool Measurement Subtypes Package"
...
# Cutting Tool Measurement Subtypes Package

This section lists the [`Measurement`]({% link model/AssetInformationModel/Pallet/Measurements/Measurement.md %}) subtypes for [`CuttingTool`]({% link model/AssetInformationModel/CuttingTool/CuttingTool.md %}).
...
![Cutting Tool Measurement 1]({% link figures/Cutting Tool Measurement 1.png %} "Cutting Tool Measurement 1"){: width="80.0%"}

![Cutting Tool Measurement 2]({% link figures/Cutting Tool Measurement 2.png %} "Cutting Tool Measurement 2"){: width="80.0%"}
