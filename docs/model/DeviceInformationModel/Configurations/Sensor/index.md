...
![Sensing Element provided as a DataItem Example]({% link figures/Sensing Element provided as a DataItem Example.png %} "Sensing Element provided as a DataItem Example"){: width="80.0%"}
...
![Sensor for Rotary Axis Example]({% link figures/Sensor for Rotary Axis Example.png %} "Sensor for Rotary Axis Example"){: width="80.0%"}
...
![Sensor unit with Sensing Elements Example]({% link figures/Sensor unit with Sensing Elements Example.png %} "Sensor unit with Sensing Elements Example"){: width="80.0%"}
...
![Sensor Configuration Example]({% link figures/Sensor Configuration Example.png %} "Sensor Configuration Example"){: width="80.0%"}
