...
![Sensing Element provided as a DataItem Example](/figures/Sensing%20Element%20provided%20as%20a%20DataItem%20Example.png "Sensing Element provided as a DataItem Example"){: width="80.0%"}
...
![Sensor for Rotary Axis Example](/figures/Sensor%20for%20Rotary%20Axis%20Example.png "Sensor for Rotary Axis Example"){: width="80.0%"}
...
![Sensor unit with Sensing Elements Example](/figures/Sensor%20unit%20with%20Sensing%20Elements%20Example.png "Sensor unit with Sensing Elements Example"){: width="80.0%"}
...
![Sensor Configuration Example](/figures/Sensor%20Configuration%20Example.png "Sensor Configuration Example"){: width="80.0%"}
