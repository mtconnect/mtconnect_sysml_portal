...
leaf [`Component`]({% link model/DeviceInformationModel/Components/Component.md %}) composed of a heat exchange system that uses a fluid to transfer heat to the atmosphere.
