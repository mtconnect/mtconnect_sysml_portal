...
![Components]({% link figures/Components.png %} "Components"){: width="80.0%"}
...
![Device Entity Hierarchy Example]({% link figures/Device Entity Hierarchy Example.png %} "Device Entity Hierarchy Example"){: width="80.0%"}
