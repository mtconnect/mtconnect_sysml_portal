...
![VariableDataSet]({% link figures/VariableDataSet.png %} "VariableDataSet"){: width="80.0%"}
...
![DataSet Example]({% link figures/DataSet Example.png %} "DataSet Example"){: width="80.0%"}
