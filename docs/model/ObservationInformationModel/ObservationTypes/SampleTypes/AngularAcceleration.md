...
| Name | Int | Dep |
|---|---|---|
| [`AngularAcceleration.Actual`]({% link model/ObservationInformationModel/ObservationTypes/SampleTypes/AngularAccelerationActual.md %}) | 1.8 |  |
| [`AngularAcceleration.Commanded`]({% link model/ObservationInformationModel/ObservationTypes/SampleTypes/AngularAccelerationCommanded.md %}) | 1.8 |  |
| [`AngularAcceleration.Programmed`]({% link model/ObservationInformationModel/ObservationTypes/SampleTypes/AngularAccelerationProgrammed.md %}) | 1.8 |  |
