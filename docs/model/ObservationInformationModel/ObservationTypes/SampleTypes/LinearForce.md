...
<span class="hoverterm">force<span class="definition" data-term="force">push or pull on a mass which results in an acceleration.</span></span> applied to a mass in one direction only.
