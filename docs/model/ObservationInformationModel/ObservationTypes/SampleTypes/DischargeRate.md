...
value of current being drawn from the [`Component`]({% link model/DeviceInformationModel/Components/Component.md %}).
...
| Name | Int | Dep |
|---|---|---|
| [`DischargeRate.Actual`]({% link model/ObservationInformationModel/ObservationTypes/SampleTypes/DischargeRateActual.md %}) | 2.1 |  |
| [`DischargeRate.Target`]({% link model/ObservationInformationModel/ObservationTypes/SampleTypes/DischargeRateTarget.md %}) | 2.1 |  |
