...
| Name | Int | Dep |
|---|---|---|
| [`OpenDoor.Request`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/OpenDoorRequest.md %}) | 1.3 |  |
| [`OpenDoor.Response`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/OpenDoorResponse.md %}) | 1.3 |  |
