...
| Name | Int | Dep |
|---|---|---|
| [`MaterialRetract.Request`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialRetractRequest.md %}) | 1.3 |  |
| [`MaterialRetract.Response`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialRetractResponse.md %}) | 1.3 |  |
