...
| Name | Int | Dep |
|---|---|---|
| [`MaterialLoad.Request`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialLoadRequest.md %}) | 1.3 |  |
| [`MaterialLoad.Response`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialLoadResponse.md %}) | 1.3 |  |
