...
| Name | Int | Dep |
|---|---|---|
| [`MaterialChange.Request`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialChangeRequest.md %}) | 1.3 |  |
| [`MaterialChange.Response`]({% link model/InterfaceInteractionModel/DataItemTypesforInterface/MaterialChangeResponse.md %}) | 1.3 |  |
